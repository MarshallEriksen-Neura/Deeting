'use client';
import { ChevronDown, LayoutGrid, Home, LayoutDashboard, ShoppingBag, LogOut, Settings, Sun, Moon, Cpu, Zap, Check } from 'lucide-react';
                          ...
                          <div className="space-y-3">
                            {serviceModelGroups.map((group) => (
                              <div
                                ...
                                className="rounded-2xl bg-white/60 dark:bg-black/30 border border-black/5 dark:border-white/10"
                              >
                                  ...
                                  {group.models.map((model) => {
                                    ...
                                    return (
                                      <Button
                                        ...
                                        className={`h-9 justify-between rounded-xl px-3 text-[11px] font-semibold ${
                                          isActive
