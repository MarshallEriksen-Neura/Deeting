...
jest.mock("@/components/models/page-header", () => ({
  PageHeader: ({
    title,
    description,
    actions,
...
jest.mock("@/components/ui/shadcn/textarea", () => ({
  Textarea: (
    props: React.TextareaHTMLAttributes<HTMLTextAreaElement>,
  ) => <textarea {...props} />,
}))

jest.mock("@/components/ui/shadcn/label", () => ({
  Label: ({
    children,
    ...props
...
jest.mock("@/components/ui/shadcn/tabs", () => ({
...
jest.mock("@/components/ui/shadcn/switch", () => ({
  Switch: ({
    checked,
    onCheckedChange,
  }: {
...
jest.mock("@/components/ui/shadcn/scroll-area", () => ({
  ScrollArea: ({ children }: { children: React.ReactNode }) => <div>{children}</div>,
}))

jest.mock("@/components/ui/shadcn/separator", () => ({
  Separator: () => <hr />,
}))

jest.mock("@/components/ui/shadcn/checkbox", () => ({
  Checkbox: ({
    checked,
    onCheckedChange,
  }: {
...
jest.mock("@/components/ui/shadcn/collapsible", () => ({
...
jest.mock("@/components/ui/common/glass-card", () => ({
...
jest.mock("@/components/ui/shadcn/skeleton", () => ({
