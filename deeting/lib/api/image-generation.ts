...
const ImageGenerationTaskListItemSchema = z.object({
  task_id: z.string(),
  status: z.string(),
  model: z.string(),
...
const ImageGenerationTaskPageSchema = z.object({
  items: z.array(ImageGenerationTaskListItemSchema),
...
>
export type ImageGenerationTaskListItem = z.infer<
  typeof ImageGenerationTaskListItemSchema
>
...
>
export type ImageGenerationTaskPage = z.infer<
  typeof ImageGenerationTaskPageSchema
>
