...
pub struct LocalFramePhaseAlignmentReadinessResponse {
    ...
    pub direct_iteration_sample_count: usize,
    pub non_direct_strategy_sample_count: usize,
    pub non_direct_strategy_ratio: Option<f64>,
    pub minimum_non_direct_strategy_ratio: f64,
    pub strategy_distribution_met: bool,
...
impl From<FramePhaseAlignmentReadiness> for LocalFramePhaseAlignmentReadinessResponse {
    fn from(readiness: FramePhaseAlignmentReadiness) -> Self {
        Self {
            ...
            direct_iteration_sample_count: readiness.direct_iteration_sample_count,
            non_direct_strategy_sample_count: readiness.non_direct_strategy_sample_count,
            non_direct_strategy_ratio: readiness.non_direct_strategy_ratio,
            minimum_non_direct_strategy_ratio: readiness.minimum_non_direct_strategy_ratio,
            strategy_distribution_met: readiness.strategy_distribution_met,
