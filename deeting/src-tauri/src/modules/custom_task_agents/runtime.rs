...
use super::prompt_definitions::{
    render_custom_task_agent_system_prompt, render_worker_task_packet_system_prompt,
    render_worker_task_packet_user_message, CustomTaskAgentPromptInput,
    LLM_WIKI_MAINTAINER_SOURCE_KIND,
};
...
fn build_initial_messages(
    ...
    let mut messages = vec![LocalChatInputMessage {
        ...
        content: render_custom_task_agent_system_prompt(&CustomTaskAgentPromptInput::from_profile(
            profile,
            guidance_skills,
    ...
    if let Some(packet) = worker_task_packet {
        messages.push(LocalChatInputMessage {
            role: "system".to_string(),
            content: render_worker_task_packet_system_prompt(),
            reasoning_content: None,
            tool_calls: vec![],
            tool_call_id: None,
            name: None,
        ...
        messages.push(LocalChatInputMessage {
            role: "user".to_string(),
            content: render_worker_task_packet_user_message(packet),
            reasoning_content: None,
            tool_calls: vec![],
            tool_call_id: None,
            name: None,
