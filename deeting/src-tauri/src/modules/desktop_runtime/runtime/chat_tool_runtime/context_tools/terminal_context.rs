...
pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) fn is_terminal_context_tool(
    tool_name: &str,
) -> bool {
    matches!(
        tool_name,
...
pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) fn execute_terminal_context_tool(
    app: &AppHandle,
