...
pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) fn is_workflow_plan_tool(
    tool_name: &str,
) -> bool {
    matches!(
        tool_name,
...
pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) async fn execute_workflow_plan_tool(
    app: &AppHandle,
    app_state: &AppState,
