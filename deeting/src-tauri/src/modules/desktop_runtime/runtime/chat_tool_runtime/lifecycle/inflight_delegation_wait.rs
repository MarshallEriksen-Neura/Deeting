...
pub(crate) struct PersistedDelegationWait {
    ...
    #[serde(default)]
    pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) delegated_target_id:
        Option<String>,
    #[serde(default)]
    pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) delegated_target_name:
        Option<String>,
    ...
    #[serde(default)]
    pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) consumed_event_ids:
        Vec<String>,
    #[serde(default)]
