...
pub(crate) struct PersistedPendingApproval {
    ...
    pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) arguments: serde_json::Value,
    pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) call_id: Option<String>,
    pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) execution_token: Option<String>,
    ...
    pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) policy_rule_key: Option<String>,
    pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) approval_grant_key: Option<String>,
    pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) execution_graph_execution_id: Option<String>,
    pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) execution_graph_gate_node_id: Option<String>,
    pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) execution_graph_tool_node_id: Option<String>,
    pub(in crate::modules::desktop_runtime::runtime::chat_tool_runtime) approval_status: Option<String>,
