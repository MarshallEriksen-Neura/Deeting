...
mod tests {
    ...
    #[test]
    fn render_code_mode_prompt_guides_cli_skill_docs_to_shell_execution() {
        let prompt = render_code_mode_capability_prompt(&[
            "search_sdk".to_string(),
            "shell_execute".to_string(),
            "execute_code_plan".to_string(),
