...
export function LoginForm({ onSuccess, onError, className }: LoginFormProps) {
  ...
  const isDesktopExternalBrowserEnabled = tauriRuntime && desktopExternalLoginUrl.length > 0
  ...
  const [oauthLoadingProvider, setOAuthLoadingProvider] = React.useState<"google" | "github" | null>(null)
  ...
  const showDesktopOAuthActions = tauriRuntime || hasDesktopBrowserSession
  ...
  async function handleOAuthLogin(provider: "google" | "github") {
    try {
      ...
      if (hasDesktopBrowserSession && !tauriRuntime) {
        const session = await prepareDesktopOAuth(provider)
  ...
  return (
    <div className={cn("grid gap-6", className)}>
      ...
      {isDesktopExternalBrowserEnabled ? (
            ...
            <>
              ...
              <div className="grid gap-3">
                ...
                >
                  ...
                  {oauthLoadingProvider === "google" && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                  {t("oauthGoogle")}
                </GlassButton>
                ...
                >
                  ...
                  {oauthLoadingProvider === "github" && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                  {t("oauthGithub")}
                </GlassButton>
              </div>
            </>
