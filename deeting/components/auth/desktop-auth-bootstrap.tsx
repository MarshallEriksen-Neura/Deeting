    ...
    const restoreDesktopSession = async () => {
      ...
      try {
        ...
        if (hydrationState === "timeout") {
          console.warn(
            "desktop auth bootstrap hydration timed out; continuing with desktop config recovery"
          );
        }
        ...
        const normalizedToken = typeof persistedToken === "string" ? persistedToken.trim() : "";
        if (!normalizedToken) {
          return;
        }
