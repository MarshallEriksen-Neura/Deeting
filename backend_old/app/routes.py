...
from .api.v1.admin_agent_routes import router as admin_agent_router
...
from .api.v1.admin_provider_rules_routes import router as admin_provider_rules_router
...
from .api.v1.admin_router_routes import router as admin_router_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(admin_provider_rules_router)
    app.include_router(admin_router_router)
