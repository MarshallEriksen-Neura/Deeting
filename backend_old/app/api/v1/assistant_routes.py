...
async def message_speech_endpoint(
    ...
    if payload.reference_audio_url is not None:
        # 若直接提供 URL，则优先使用该 URL（无需查询 asset）
        reference_audio_url = str(payload.reference_audio_url)
    elif payload.prompt_audio_id is not None:
