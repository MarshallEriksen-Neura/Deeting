...
celery_app.conf.update(
    ...
    accept_content=["json"],
    # 队列路由配置：agent 任务使用独立队列以控制并发
    task_routes={
        "tasks.agent_crawl_*": {"queue": "agent_crawl"},
        "tasks.agent_upload_*": {"queue": "agent_ingest"},
        "tasks.agent_ingest_*": {"queue": "agent_ingest"},
        "tasks.agent_rule_*": {"queue": "agent_ingest"},
    },
    ...
    imports=(
        ...
        "app.tasks.video_generation_run",
