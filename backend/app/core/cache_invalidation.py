...
class CacheInvalidator:
    ...
    async def on_preset_updated(self, preset_id: str | None = None) -> None:
        ...
        await self._clear_prefix("preset:")
        await self._clear_prefix("routing:")
    ...
    async def bump_version(self) -> int:
        ...
        try:
            ...
            await redis.set(cache._make_key(self.updated_at_key), datetime.utcnow().isoformat(), ex=24 * 3600)
            return version
        except Exception as exc:
