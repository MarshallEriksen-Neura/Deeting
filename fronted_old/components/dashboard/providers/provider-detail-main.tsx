      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="models">
          <ProviderModelsTab
            ...
            capabilityLabels={{
              chat: t("providers.capability_chat"),
              completion: t("providers.capability_completion"),
              embedding: t("providers.capability_embedding"),
              vision: t("providers.capability_vision"),
              audio: t("providers.capability_audio"),
              function_calling: t("providers.capability_function_calling"),
              image_generation: t("providers.capability_image_generation"),
            }}
          />
        </TabsContent>
